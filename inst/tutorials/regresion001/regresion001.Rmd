...
##### 2. Estime un modelo de regresion ineal simple que permita encontrar la relacion entre Vantas semanales y el espacio asignado
...
##### 7. Estime el valor promedio de las ventas en caso de tener un espacio promedio de 5 $ft^2$
